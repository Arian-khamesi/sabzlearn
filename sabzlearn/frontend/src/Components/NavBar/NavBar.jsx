          ...
          <div class="main-header__content">
            <div class="main-header__right">
              ...
              <ul class="main-header__menu">
                ...
                <li class="main-header__item">
                  <a href="#" class="main-header__link"><span className='main-header__link-span'>فرانت اند</span>
                ...
                <li class="main-header__item">
                  <a href="#" class="main-header__link"><span className='main-header__link-span'>امنیت</span>
                    <i class="fas fa-angle-down main-header__link-icon"></i>
                    <ul class="main-header__dropdown">
                      <li class="main-header__dropdown-item">
                ...
                <li class="main-header__item">
                  <a href="#" class="main-header__link"><span className='main-header__link-span'>مقالات</span>
                    <i class="fas fa-angle-down main-header__link-icon"></i>
                    <ul class="main-header__dropdown">
                      <li class="main-header__dropdown-item">
                ...
                <li class="main-header__item">
                  <a href="#" class="main-header__link"><span className='main-header__link-span'>پایتون</span>
                    <i class="fas fa-angle-down main-header__link-icon"></i>
                    <ul class="main-header__dropdown">
                      <li class="main-header__dropdown-item">
                ...
                <li class="main-header__item">
                  <a href="#" class="main-header__link"><span className='main-header__link-span'>مهارت های نرم</span></a>
                </li>
              </ul>
            </div>
